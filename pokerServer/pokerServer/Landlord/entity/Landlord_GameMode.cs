...
namespace pokerServer.Landlord.entity {
    public class Landlord_GameMode {
        ...
        public void changeOrder(List<Card> deck, CardOrderMode orderMode) {
            switch (orderMode) {
                case CardOrderMode.CARD_NUM:
                    deck.Sort(Card.CompareModeCardNum);
                break;
                case CardOrderMode.CARD_SIZE:
                    deck.Sort(Card.CompareModeCardSize);
                break;
                case CardOrderMode.CARD_DISPLAY:
                    deck.Sort(Card.CompareModeDisplayCard);
                break;
            }
        }
